...
#Basically we built it from scratc that's why we have to save logs
class DataLogger:
...
class Trainer:
    ...
    def _save_checkpoint(self):
        ...
        print(f"Model Checkpount saved at {checkpoint_path}")
...
if __name__=="__main__":
    ...
    print("Run the command line:\n --> tensorboard --logdir=model_training-train_steering_angle/logs Then open http://0.0.0.0:6006/ into your web browser")
